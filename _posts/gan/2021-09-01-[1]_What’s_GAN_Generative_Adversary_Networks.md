...
생성자를 위한 기울기는 점점 0에 수렴해 없어질 것이고 최적화를 매우 느리게 만든다. 이를 개선하기 위해 GAN에서는 생성자에 기울기를 역전파하게 하는 반대 함수를 제공한다. 이것에 대한 설명은 GAN 논문 포스팅에서 추후 다룰 예정이다!✌️ => [논문 포스팅 gogo~](https://chaelin0722.github.io/paperreview/generative_adversarial_nets/)
