...
단지 아쉬운 점은.. 서버에서 작업했었던 이전의 프로젝트들을 불러올 수 없다는 점이 단점인데.. 찾아낸 것이 vscode이다. vscode로 더 간단하게 ssh 연결이 가능하니, 더 간편하고, 자동으로 동기화 되는 것이 필요하신 분은 [vscode ssh 원격접속](https://chaelin0722.github.io/mac/vscode_ssh/) 에서 확인해 보세요!
