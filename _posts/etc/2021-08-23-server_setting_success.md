...
드라이버 버전확인 표!  [사이트는 여기!](https://docs.nvidia.com/cuda/cuda-toolkit-release-notes/index.html)

![image](https://user-images.githubusercontent.com/53431568/155449432-b58e15ba-9fd4-455e-9c7c-343b072d1548.png)


그리고, 어떤 버전을 깔던 자신의 컴퓨터 사양 스펙을 알고, 사이트에서 진행해주는 대로만 따라하면 됩니다! 
[CUDA 11.2 VERSION 사이트](https://developer.nvidia.com/cuda-11.2.0-download-archive?target_os=Linux&target_arch=x86_64&target_distro=Ubuntu&target_version=2004&target_type=deblocal)
