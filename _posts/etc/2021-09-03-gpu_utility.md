...
현재 GPU하나로 학습을 돌리면 보이는 내 GPU 상태.. 아래 명령어로 GPU상황이 매 1초마다 업데이트 되어 실시간으로 볼 수 있다.
...
![gpu parallel](https://user-images.githubusercontent.com/53431568/132236908-aad867e7-6508-4053-a4e1-a8d9b7eb0af0.PNG)
