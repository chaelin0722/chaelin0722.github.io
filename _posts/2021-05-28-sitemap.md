...
**- <loc>https://chaelin0722.github.io{{ post.url }}</loc> 과 같이 자신의 블로그 주소로 바꿔준다! 앞에 https:// 를 반드시 붙여서 적여야 한다.
