...
[논문링크](https://papers.nips.cc/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf)
2012 ILSVRC에서 수상한 neural network
...
**8) 여덟번째 레이어(Fully connected layer):** 1000개의 뉴런으로 구성되어 있다. 전 단계의 4096개 뉴런과 fully connected되어 있다. 1000개 뉴런의 출력값에 [softmax 함수](https://bskyvision.com/427)를 적용해 1000개 클래스 각각에 속할 확률을 나타낸다.
